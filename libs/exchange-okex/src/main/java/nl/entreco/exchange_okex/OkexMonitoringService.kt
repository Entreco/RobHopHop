...
class OkexMonitoringService(
    private val exchange: Exchange
) : ExchangeMonitoringService {

    private val ws by lazy { ExchangeClientFactory.websocket(ExchangeVendor.OKEX) }
    ...
    override suspend fun triangular(triangle: Triple<Currency, Currency, Currency>): Flow<Arbitrage> = callbackFlow {
        ...
        var arbitrage = Arbitrage(ExchangeVendor.OKEX.name, triangle)
