...
class UpbitMonitoringService(
    private val exchange: Exchange
) : ExchangeMonitoringService {

    private val ws by lazy { ExchangeClientFactory.websocket(ExchangeVendor.UPBIT) }
    ...
    override suspend fun triangular(triangle: Triple<Currency, Currency, Currency>): Flow<Arbitrage> = callbackFlow {
        ...
        var arbitrage = Arbitrage(ExchangeVendor.UPBIT.name, triangle)
